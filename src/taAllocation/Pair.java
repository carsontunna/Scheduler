...
/**
 * Implements a simple key/value pair which supports the
 * {@link java.lang.Comparable} contract and the {@link java.util.Map.Entry}
 * contract.
 * 
 * <p>
...
public class Pair<K, V> implements Map.Entry<K, V>, Comparable {
	 ...
	 *            the key
	 * @param value
	 *            the value that coorosponds the the key
	 */
	...
	/**
	 * Sets the key to Key and returns the old value.
	 * 
	...
	/**
	 * Implements the {@link Comparable#compareTo(Object)} contract for two Pair
	 * objects by first attempting to compare the keys, and if they are equal,
	 * comparing the values. If the argument is not a Pair object, then throw
	 ...
	 * 
	 * @param x
	 *            the object to compare with y
	 * @param y
	 *            the object to be campared
